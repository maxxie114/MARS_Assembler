...
public class TextAreaPainter extends JComponent implements TabExpander {
  ...
  public void paint(Graphics gfx) {
    ...
    ((Graphics2D) gfx).setRenderingHint(RenderingHints.KEY_RENDERING,
    ...
    try {
      ...
      System.err
          .println("Error repainting line" + " range {" + firstInvalid + "," + lastInvalid + "}:");
      e.printStackTrace();
    }
  }
  ...
  protected void paintPlainLine(Graphics gfx, int line, Font defaultFont, Color defaultColor, int x,
      int y) {
    paintHighlight(gfx, line, y);
